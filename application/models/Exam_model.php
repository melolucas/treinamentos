...
class Exam_model extends CI_Model
{
    ...
    public function get_exame($id)
    {   
        $this->db->select('exam_taken_date, user_id, exam_id');
        $this->db->where('exam_id', $id);
    ...
    public function get_examePeriodo($usuario,$id)
    {   
        $this->db->select('exam_taken_date');
        $this->db->where('exam_id', $id);
   ...
   public function evaluate_result()
    {
     ...
     //   echo "<pre/>"; print_r($total_ques); exit();
