    ...
    <div class="container">
        <div class="box">
            <div class="row">
                <div class="col-sm-12">
                    <h3>Ache-nos</h3>
                    <p>Escreva uma mensagem, nós retornaremos para você.</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <?=form_open(base_url('index.php/guest/contact'), 'role="form" id="contact_form" class="contact-form"'); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12 minpadding">
                               <?=form_input('name', '', 'placeholder="Seu nome " class="form-control" id="name" required="required"') ?>
                            </div>
                            <div class="col-sm-6 col-xs-12 minpadding">
                               <?=form_input('email', '', 'id="email" pattern="^[a-zA-Z0-9.!#$%&'."'".'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$" title="you@domain.com" placeholder="Seu endereço de email" type="email" class="form-control" required="required"') ?>
                            </div>
                            <div class="col-sm-12 minpadding">
                                <?=form_input('subject', '', 'id="subject" placeholder="Assunto" class="form-control" required="required"') ?>
                            </div>
                            <div class="col-sm-12 minpadding">
                                <div class="form-group">
                                    <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="mensagem"></textarea>
                                </div>
                                <button type="submit" class="btn btn-info  btn-outline btn-lg"><i class="fa fa-envelope-o"></i> Enviar mensagem</button>
                            </div>
                        </div>
                    <?=form_close(); ?>
