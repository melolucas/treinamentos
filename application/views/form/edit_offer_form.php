...
<div class="block">  
    <div class="navbar block-inner block-header">
        <div class="row">
            <p class="text-muted">Modificar Ofertas</p>
        </div>
    </div>
            ...
            <div class="col-sm-12">
              <?php echo form_open(base_url() . 'index.php/membership/update', 'role="form" class="form-horizontal"'); ?>
                ...
                <div class="form-group">
                  <label for="membership_type" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Tipo de Membro:</label>
                ...
                <div class="form-group">
                    <label for="feature_1" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Característica <?=$i ?>:</label>
                    <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                      <?php 
                        $data = array(
              ...
              <div class="col-xs-offset-1 col-sm-offset-2 col-xs-4">
                  <button type="submit" class="btn btn-primary col-xs-6">Atualizar</button>&nbsp;
              </div>
            <?php echo form_close() ?>
