    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group" id="media-choose">
                ...
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                    <a href="#" class="btn btn-default" id='upload-media-file'>Escolher</a>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="ans_type" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Tipo de resposta: </label>
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
            ...
            <div class="row">
                <div class="col-xs-offset-1 col-xs-11 col-sm-offset-2 col-md-8">
                    <button type="submit" onclick="$('#progressBar').show();" class="btn btn-primary col-xs-5 col-sm-3"> <i class="glyphicon glyphicon-ok"></i> Salvar e adicionar mais</button>
                    <button type="submit" onclick="$('#progressBar').show();" class="btn btn-info col-xs-offset-1" name="done" value="done"><i class="glyphicon glyphicon-saved"></i> Salvar e Feito</button>
                </div>
            </div><br/>
            </form>
        </div>
