    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="form-group">
                <label for="faq_grp_id" class="col-sm-offset-0 col-md-2 col-xs-offset-1 col-xs-3 control-label mobile">Grupo: </label>
            ...
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-md-2 col-xs-offset-1 col-xs-3 control-label mobile">Questão: </label>
                <div class="col-sm-8 col-xs-7 col-mb">
                    <?php echo form_input('faq_q', $faq->faq_ques, 'placeholder="FAQ Question" class="form-control" required="required"') ?>
                </div>
            </div>
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-md-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Responda : </label>
                <div class="col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'faq_ans',
