...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Add novo FAQs </p></div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Questão: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                    <?php echo form_input('faq_q', '', 'placeholder="FAQ Question" class="form-control" required="required"') ?>
                </div>
            </div>
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Responda : </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'faq_ans',
            ...
            <div class="row">
                <div class="col-xs-offset-1 col-xs-11 col-sm-offset-2 col-md-8">
                    <button type="submit" class="btn btn-primary col-xs-5 col-sm-3">Salvar e feito</button>
                    <button type="submit" name="more" value="1" class="btn btn-info col-xs-5 col-sm-3 col-xs-offset-1">Salve e continue</button>
                </div>
            </div>
            </form>
        </div>
