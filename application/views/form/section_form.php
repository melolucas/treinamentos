...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Add seções </p></div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="form-group">
                <label for="section_1" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Título da seção 1: </label>
            ...
            <div class="form-group">
                <label for="section_2" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Título da seção 2: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'section[]',
            ...
            <div class="form-group">
                <label for="section_3" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Título da seção 3: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'section[]',
            ...
            <div class="form-group">
                <label for="section_4" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Título da seção 4: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'section[]',
            ...
            <div class="form-group">
                <label for="section_5" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Título da seção: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'section[]',
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                    <button type="button" class="btn btn-warning" id="add_btn" onclick="add_field()"><icon class="icon-plus"></icon> Add Mais</button>
                </div>
            </div><hr/>
            <div class="row">
