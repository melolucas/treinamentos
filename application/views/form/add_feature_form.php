...
<div class="block">  
    <div class="navbar block-inner block-header">
        <div class="row">
            <p class="text-muted">Novo recurso</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label for="membership_id" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Tipo de Membro:*</label>
                  <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                      <?php echo form_dropdown('membership_id', $option,'','class="form-control"') ?>
                  </div>
                </div>
                <div class="form-group">
                    <label for="feature_1" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Recurso 1:*</label>
                    <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                      <?php 
                        $data = array(
                            'name'        => 'feature[]',
