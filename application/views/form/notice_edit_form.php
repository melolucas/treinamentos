...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Editar Aviso </p></div>
    </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <select name="notice_status" id="status" class="form-control">
                    <option value="1" <?php if($notice->notice_status) echo 'selected'; ?> >Ativo</option>
                    <option value="0" <?php if(!$notice->notice_status) echo 'selected'; ?> >Inativo</option>
                </select>
                </div>
            </div>
            <div class="form-group">
                <label for="title" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Título: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
            ...
            <div class="form-group">
                <label for="daterange" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Data Alcance: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
