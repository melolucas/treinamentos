...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Editar Post </p></div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="form-group">
                <label for="blog_title" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Titulo: </label>
            ...
            <div class="form-group">
                <label for="blog_body" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Conteúdo : </label>
