...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted"><?=($msg_info->message_folder == 'draft')?'Editar mensagem':'Responder à mensagem' ?></p></div>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">para: </label>
            ...
            <div class="form-group">
                <label for="subject" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Assunto: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                   <?php 
                    if ($msg_info->message_folder == 'draft') {
            ...
            <div class="form-group">
                <label for="cat_name" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Mensagem : </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'reply_message',
