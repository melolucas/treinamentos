                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <p class="dashboard-text text-center">Ver Resultado</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <p class="dashboard-text text-center">Faça um novo exame</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-tasks"></i> Seus últimos resultados</h3>
            </div>
            <div class="panel-body">
               <div class="col-sm-12">
                            ...
                            foreach ($results as $result) {
                                ...
                                <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                    ...
                                    <td class="text-center" style=" width: 17%">
                                        <div class="btn-group">
                                            <a class="btn btn-default btn-sm" href = "<?= base_url('index.php/exam_control/view_result_detail/' . $result->result_id); ?>"><i class="glyphicon glyphicon-eye-open"></i><span class="invisible-on-md">  Ver</span></a>
                                            <a onclick="return delete_confirmation()" href = "<?= base_url('index.php/exam_control/delete_results/' . $result->result_id); ?>" class="btn btn-sm btn-default" ><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Excluir </span></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php 
