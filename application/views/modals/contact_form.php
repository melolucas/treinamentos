    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-compose-mail-header" style="padding: 15px;">
                ...
                <p class="modal-title">Escreva para nós</p>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                   <?php echo form_input('name', '', 'placeholder="Seu nome (obrigatório)" class="form-control" id="name" required="required"') ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <?php echo form_input('subject', '', 'id="subject" placeholder="Assunto (obrigatório)" class="form-control" required="required"') ?>
                </div>
