...
<div class="modal fade" id="update_ques" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="TRUE">  
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Formulário de atualização de pergunta</h4>
      </div>
      <div class="modal-body">
        <?php echo form_open(base_url() . 'index.php/admin_control/update_question','role="form" class="form-horizontal"'); ?>
          ...
          <div class="form-group">
            <label for="question" class="col-xs-3 control-label">Questão :</label>
            <div class="col-xs-8">
                <?php 
                $data = array(
                    'name'        => 'question',
          ...
          <br/>
          <p class="col-sm-offset-3 col-xs-offset-1"><i class="glyphicon glyphicon-warning-sign text-warning"></i><span class="text-muted"> Deve ter pelo menos 8 caracteres de comprimento.</span></p>
      </div>
