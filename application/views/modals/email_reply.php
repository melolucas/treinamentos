    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-compose-mail-header">
                ...
                <p class="modal-title">Compor mensagem</p>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group modal-compose-mail-body">
                   <textarea name="message" placeholder="Sua mensagem" class="form-control textarea-wysihtml5" rows="10" maxlength="250" required="required"></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-envelope-o"></i> Enviar</button>
                <button type="submit" name="save" value="save" class="btn btn-default"><i class="fa fa-save"></i> Salvar como rascunho</button>
                <?php echo form_close() ?>
