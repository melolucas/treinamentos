...
<form id="anserForm" action="<?= base_url('index.php/course/course_summary/'.$course_sections->course_id); ?>" method="post">
            ...
            <div class="carousel-inner">
                <?php foreach ($questions as $ques): $type = ($ques->option_type == 'Radio') ? 'radio' : 'checkbox'; ?>
                    ...
                    <div class="item <?= ($count == $num_of_ques) ? 'active' : '' ?>">
                        <div class="row">
                            <div class="col-md-12">
                                <p>Questão <?= ($num_of_ques - $count + 1) . ' of ' . $num_of_ques; ?> 
    ...
    <div class="container me-control-btn">
        ...
        <a class="btn btn-lg btn-info col-xs-5 col-xs-offset-2 me-next" href="#Carousel" data-slide="prev"> Próxima <span class="hidden-xxs">Questão</span> &raquo; </a>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function timer() {
            ...
            if (h) {
                if (h.toString().length == 1)
                    h = '0' + h;
                newTime = '<strong>' + h + ':' + m + ':' + s + '</strong> <small class="text-muted">Horas</small>';
            } else {
        ...
        // Coltrol Buttons    
        var submit_btn = '<button type="submit" class="btn btn-lg btn-success col-xs-6 col-xs-offset-3" > <i class="fa fa-check-square-o"></i> Submit <span class="hidden-xxs">suas respostas </span></a>';
        var slide_count = 1;
