                ...
                foreach ($memberships as $offer) { ?>
                    <div class="col-md-<?=($count > 3)?'3':'4'; ?> col-sm-6 col-xs-12 float-shadow nopadding">
                        ...
                        <div class="price_table_container">
                            ...
                            <a href="<?=base_url('index.php/membership/payment_process/'.$offer->price_table_id);?>" class="btn <?=($offer->price_table_top)?'btn-dark':' btn-static'; ?> btn-lg btn-block">Se inscrever</a>
                        </div>
                    </div>
                <?php } ?>
            </div><!--/.row-->
