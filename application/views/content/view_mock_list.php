	        ...
	        <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12 nopadding">
					<ul class="nav  category-menu" style="float:left;">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle disabled" data-toggle="dropdown"><i class=" fa fa-sitemap"></i> &nbsp;Todas as categorias </span></a>
                ...
                <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 nopadding">
                    <h4><?=isset($category_name)?$category_name:'Todos Exames'; ?></h4>
                    <?php if ($commercial) { ?>
                    <div class="btn-group pull-right">
                        ...
                        <a href="<?=base_url('index.php/exam_control/mocks_type/free') ?>" class="btn btn-sm btn-default"></a>
                    </div>
                    <?php } ?>                
	                <div class="exam-list">
	                <?php 
	                                    ...
	                                    <div class="thumbnail">
	                                        <a href="<?=base_url('index.php/exam_control/view_exam_summery/'.$mock->title_id); ?>">
	                                            ...
	                                            <div class="caption">
	                                                ...
	                                                <p> 
	                                                    <time class="total-question" ><?=($mock->random_ques_no != 0) ? $mock->random_ques_no : $this->db->where('exam_id', $mock->title_id)->get('questions')->num_rows();?> questões</time>
	                                                    <div class="exam-duration" ><?=($hr)?$mock->time_duration.' horas':$minutes.' minutos';?></div>
