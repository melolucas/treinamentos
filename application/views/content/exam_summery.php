            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-sm-offset-0">
                    <ol class="breadcrumb hidden-print">
                        ...
                        <li class="active">Resumo do exame</li>
                    </ol>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-info">
                                <div class="panel-heading">Resumo do exame:</div>        
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <table class="table table-condensed">
                                        ...
                                        <tr>
                                            <th>Pontuação de aprovação:</th>
                                            <td><?= $mock->pass_mark ?>%</td>
                                        </tr>
                                        <tr>
                                            <th>Duração:</th>
                                            <td><?=$mock->time_duration ?> <span class="text-muted"> horas</span></td>
                                        </tr>
                                    </table>
                                </div>        
                            </div>
                    ...
                    ?>
                        <a href="<?=base_url('index.php/exam_control/view_exam_instructions/'.$mock->title_id);?>" class="btn btn-primary"> Entre para iniciar </a>
                    <?php 
                    } ?>
