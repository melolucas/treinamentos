                                ...
                                <div class="carousel-inner">
                                    ...
                                    foreach ($questions as $ques):
                                        ...
                                        <div class="item <?= ($count === 0) ? 'active' : '' ?>">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p>Questão <?=$count+1 . ' of ' . $num_of_ques; ?> 
                                                        <span class="pull-right">Tempo restante: 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class=" me-control-btn">
                                    <a class="btn btn-lg btn-info col-xs-5 col-xs-offset-0 me-prev" href="#Carousel" disabled> &laquo; Questão <span class="hidden-xxs"> Anterior</span></a>
                                    <a class="btn btn-lg btn-info col-xs-5 col-xs-offset-2 me-next" href="#Carousel" > Próximo <span class="hidden-xxs">Questão</span> &raquo; </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
$(document).ready(function() {
    ...
    // Coltrol Buttons    
    var submit_btn = '<button type="submit" onclick="{return submit_validate();}" class="btn btn-lg btn-success col-xs-12" > <i class="fa fa-check-square-o"></i> Enviar <span class="hidden-xxs">Suas respostas </span></a>';
