    ...
    <div class="navbar block-inner block-header">
        <div class="row">
            <ul class="nav nav-pills">
                <li><p class="text-muted">Histórico de pagamento </p></li>
            </ul>
        </div>
    </div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatable" id="example">
            <thead>
                <tr>
                    ...
                    <th class="hide-md">Referência de Gateway</th>
                    <th>Pay Amount</th>
                    <th class="hidden-xxs">Moeda</th>
                    <th class="hidden-xxs">Referência</th>
                    <th class="hidden-xxs">Nome do aluno</th>
                </tr>
            </thead>
            <tbody>
            <?php $i = 1;
