...
<div class="block">  
    <div class="navbar block-inner block-header">
        ...
        <div class="row">
            ...
            if ($this->session->userdata['user_role_id'] < 5) { ?>
                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-2" href="<?php echo base_url('index.php/course/add_content/'.$section->course_id.'/'.$section->section_id); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add Conteúdo</a>
            <?php } ?>
            </p>
        </div>
    </div>
    ...
    <div class="col-sm-12">
                    ...
                    <ul class="inner-sortlist">
                        ...
                        <li style="margin-left: 20px;">
                            <?php if (($video->preview_type == 'Free') || ($video->preview_type == 'free')) { ?>
                                <span class="label label-default pull-right" id="preview_type-<?=$video->video_id;?>">Gratuito</span>
                            <?php } ?>
                        </li>
                        <li class="pull-right"><div class="btn-group">

                            <a class="btn btn-xs btn-default videoplaylink" data-toggle="modal" data-target="#videoModal" data-video-url="<?php echo base_url('course_videos/'.$video->course_id.'/'.$video->video_link); ?>"><i class="glyphicon glyphicon-expand"></i><span class="invisible-on-md"> Visualização</span></a>

                            <a class="btn btn-xs btn-default update"  data-update="<?=$video->video_id;?>" href="#update_video" data-toggle="modal"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-md"> Modificar </span></a>

                            <a class="btn btn-xs btn-default" onclick="return delete_confirmation();" href = "<?php echo base_url('index.php/course/delete_video/' . $video->video_id); ?>"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md"> Excluir</span></a>
                        </li>                                
                    </ul>
                </li>
                <?php
        ...
        <a id="button" class="btn btn-sm btn-warning">Update orders</a> <i class="fa fa-warning"></i> Você pode reordenar a exibição arrastando a lista.
    </div>
    </div>
    </div>
</div><!--/span-->
...
<div class="modal fade" id="update_video" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="TRUE">  
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Atualizar Título</h4>
      </div>
      <div class="modal-body">
        <?php echo form_open(base_url() . 'index.php/course/update_video','role="form" class="form-horizontal"'); ?>
          ...
          <div class="form-group">
            <label for="update_video_name" class="col-xs-3 control-label">Novo título :</label>
            <div class="col-xs-8">
            ...
            <div class="form-group">
                <label for="" class="col-xs-3 control-label mobile">Gratuito: </label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer" style=" text-align: center;">
            <button type="button" id="prevVideo" class="btn btn-default" >Vídeo anterior</button>
            <button type="button" id="nextVideo" class="btn btn-default" >Próximo Vídeo</button>
        </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
