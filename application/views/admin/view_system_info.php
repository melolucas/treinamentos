...
<div class="block">  
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Informação do sistema </p></div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab">Informação básica</a></li>
                    <li><a href="#tab_5" data-toggle="tab">Conteúdo</a></li>
                ...
                <div class="tab-content info-display">
                            ...
                            foreach ($sys_content as $value) { ?>
                                ...
                                if ($value->content_type == 'about_us') { ?>
                                    <div class="form-group">
                                        <label for="about_title" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Sobre nós:</label>
                                        <div class="col-sm-8 col-xs-7 col-mb">
                                            <?=form_input('about_title', $value->content_heading, 'placeholder="Sobre nós Título" class="form-control" required="required"') ?>
                                            <br/>
                                            <?php 
                                            $data = array(
                                                'name'        => 'about_content',
                                ...
                                if ($value->content_type == 'price_table_msg') { ?>
                                    <div class="form-group">
                                        <label for="pricing_title" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Mensagem da tabela de preços:</label>
                                        <div class="col-sm-8 col-xs-7 col-mb">
                            ...
                            <dd>
                                <blockquote>                            
                                    <p class="lead">
                                        ...
                                        <a href="<?= $sys_set->facbook_url ?>" target="_blank" class="btn btn-default btn-xs vitis-url"> Visite o link </a>
                                    </p>
                                </blockquote>
                            </dd>
                            <dt>Google+: </dt>
                            <dd>
                                <blockquote>                            
                                    <p class="lead">
                                        ...
                                        <a href="<?= $sys_set->googleplus_url ?>" target="_blank" class="btn btn-default btn-xs vitis-url"> Visite o link </a>
                                    </p>
                                </blockquote>
                            </dd>
                            <dt>Twitter: </dt>
                    ...
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="form-group">
                            <label for="support_email" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Email de suporte:</label>
                            <div class="col-sm-8 col-xs-7 col-mb">
                                <?=form_input('support_email', $sys_set->support_email, 'placeholder="Support Email" class="form-control"') ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="support_phone" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Telefone de suporte:</label>
                            <div class="col-sm-8 col-xs-7 col-mb">
                                <?=form_input('support_phone', $sys_set->support_phone, 'placeholder="Support Phone" class="form-control"') ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bussiness_type" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Tipo de Negócio:</label>
                            <div class="col-sm-8 col-xs-7 col-mb">
                                <select name="bussiness_type" class="form-control" required="required">
                                    <option value="1" <?=($sys_set->commercial == 1)?'selected':''?> >Comercial</option>
                                    <option value="0" <?=($sys_set->commercial == 0)?'selected':''?> >Não comercial</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="student_can_register" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Aluno pode se registrar:</label>
                            <div class="col-sm-8 col-xs-7 col-mb">
                                <select name="student_can_register" class="form-control" required="required">
                                    <option value="1" <?=($sys_set->student_can_register == 1)?'selected':''?>>Sim</option>
                                    <option value="0" <?=($sys_set->student_can_register == 0)?'selected':''?>>Não</option>
                                </select>
                            </div>
                        </div>
