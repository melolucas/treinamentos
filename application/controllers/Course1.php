...
//        $this->form_validation->set_rules('price', 'Price', 'required|numeric');
           ...
           // var_dump($title_id);die;
            ...
            if ($title_id) {
                $message = '<div class="alert alert-success alert-dismissable">'
                        ...
                        . '<br><br>Curso criado com Sucesso!.'
                        . '</div>';
                $course_title = $this->input->post('course_title');
                $this->ctreat_course_sections($title_id, $course_title, $message);
            } else {
                $message = '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>Ocorreu um erro! Por favor tente novamente.</div>';
    ...
    public function save_sections()
    {
        ...
        if ($this->form_validation->run() != FALSE)
        {
            if ($this->course_model->save_course_sections()) {
                $message = '<div class="alert alert-success alert-dismissable">'
                        . '<button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>'
                        . '<br><br>Seção criada com Sucesso!.'
                        . '</div>';
                $this->session->set_flashdata('message', $message);
        ...
        if ($this->input->post()) {
            ...
            // echo "<pre>"; print_r($_FILES); print_r($dest) echo "</pre>"; exit();
                ...
                if ($video_id) {
                    $message = '<div class="alert alert-success alert-dismissable">'
                            . '<button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>'
                            . '<br><br>Conteudo atualizado com Sucesso!.'
                            . '</div>';
                    $this->session->set_flashdata('message', $message);
    ...
    public function update_course($id, $message = '')
    {
        ...
        $message = '<div class="alert alert-success alert-dismissable">'
                . '<button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>'
                . '<br><br>Curso Atualizado com Sucesso!.'
                . '</div>';
            $this->session->set_flashdata('message',$message);
    ...
    function delete_course($id)
    {
        ...
        if (!empty($have_sections)) {
            ...
            $message = '<div class="alert alert-danger"><br><br>Este curso possui seções. Exclua todas as seções do curso e tente novamente.</div>';
            $this->session->set_flashdata('message', $message);
    ...
    function update_section()
    {
        ...
        if ($this->form_validation->run() != FALSE) {
            if ($this->course_model->update_section()) {
                $message = '<div class="alert alert-success alert-dismissable">'
                        . '<button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>'
                        . '<br><br>Seção atualizado com Sucesso!.'
                        . '</div>';
            }else{
    ...
    function update_video()
    {
        ...
        if ($this->form_validation->run() != FALSE) {
            if ($this->course_model->update_video()) {
                $message = '<div class="alert alert-success alert-dismissable">'
                        . '<button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>'
                        . '<br><br>Video atualizado com sucesso!.'
                        . '</div>';
            }else{
                $message = '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>An ERROR occurred! Please try again.</div>';
            }
