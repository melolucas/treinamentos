...
class Noticeboard extends MS_Controller
{
    ...
    public function add($message = '')
    {
        ...
        if ($this->session->userdata('user_role_id') > 2){
            $message = '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="TRUE">&times;</button>Você não tem permissão para visualizar esta página.</div>';
